			...
			CodeLists: []CodeList{
				{
					...
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/64d384f1-ea3b-445c-8fb8-aa453f96e58a/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "65107A9F-7DA3-4B41-A410-6F6D9FBD68C3",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/65107A9F-7DA3-4B41-A410-6F6D9FBD68C3/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "e44de4c4-d39e-4e2f-942b-3ca10584d078",
					Name:        "aggregate",
					HRef:        "http://localhost:22400/code-lists/e44de4c4-d39e-4e2f-942b-3ca10584d078/editions/one-off",
					IsHierarchy: true,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					ID:          "mmm-yy",
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/mmm-yy/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "uk-only",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/uk-only/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "cpih1dim1aggid",
					Name:        "aggregate",
					HRef:        "http://localhost:22400/code-lists/cpih1dim1aggid/editions/one-off",
					IsHierarchy: true,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					ID:          "calendar-years",
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/calendar-years/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "mid-year-pop-geography",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/mid-year-pop-geography/editions/one-off",
					IsHierarchy: true,
				}, {
					ID:          "mid-year-pop-sex",
					Name:        "sex",
					HRef:        "http://localhost:22400/code-lists/mid-year-pop-sex/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "mid-year-pop-age",
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/mid-year-pop-age/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "ashe-sex",
					Name:        "sex",
					HRef:        "http://localhost:22400/code-lists/ashe-sex/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "ashe-working-pattern",
					Name:        "workingpattern",
					HRef:        "http://localhost:22400/code-lists/ashe-working-pattern/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "ashe-hours",
					Name:        "hours",
					HRef:        "http://localhost:22400/code-lists/ashe-hours/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "ashe-statistics",
					Name:        "statistics",
					HRef:        "http://localhost:22400/code-lists/ashe-statistics/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "ashe-geography",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/ashe-geography/editions/one-off",
					IsHierarchy: true,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					HRef:        "http://localhost:22400/code-lists/opss-scheme-membership-sizeband/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "opss-status",
					Name:        "status",
					HRef:        "http://localhost:22400/code-lists/opss-status/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "opss-benefit-type",
					Name:        "benefittype",
					HRef:        "http://localhost:22400/code-lists/opss-benefit-type/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "opss-public-private-sector",
					Name:        "publicprivatesector",
					HRef:        "http://localhost:22400/code-lists/opss-public-private-sector/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "opss-membership-type",
					Name:        "membershiptype",
					HRef:        "http://localhost:22400/code-lists/opss-membership-type/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "opss-contributor",
					Name:        "contributor",
					HRef:        "http://localhost:22400/code-lists/opss-contributor/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					HRef:        "http://localhost:22400/code-lists/crime-accommodation-type/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "crime-age",
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/crime-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "england-and-wales-only",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/england-and-wales-only/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "crime-type",
					Name:        "crimetype",
					HRef:        "http://localhost:22400/code-lists/crime-type/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "crime-measurement-type",
					Name:        "measurementtype",
					HRef:        "http://localhost:22400/code-lists/crime-measurement-type/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "crime-sex",
					Name:        "sex",
					HRef:        "http://localhost:22400/code-lists/crime-sex/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					ID:          "financial-years",
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/financial-years/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "police-force-geography",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/police-force-geography/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "crime-offence",
					Name:        "offence",
					HRef:        "http://localhost:22400/code-lists/crime-offence/editions/one-off",
					IsHierarchy: true,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "migration-flow",
					Name:        "flow",
					HRef:        "http://localhost:22400/code-lists/migration-flow/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "migration-citizenship-group",
					Name:        "citizenshipgroup",
					HRef:        "http://localhost:22400/code-lists/migration-citizenship-group/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "migration-sex",
					Name:        "sex",
					HRef:        "http://localhost:22400/code-lists/migration-sex/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "migration-age",
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/migration-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "migration-country",
					Name:        "country",
					HRef:        "http://localhost:22400/code-lists/migration-country/editions/one-off",
					IsHierarchy: true,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					HRef:        "http://localhost:22400/code-lists/migration-reason-for-migration/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "migration-country",
					Name:        "country",
			...
			CodeLists: []CodeList{
				{
					ID:          "year-ending",
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/year-ending/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "wellbeing-geography",
					Name:        "geography",
					HRef:        "http://localhost:22400/code-lists/wellbeing-geography/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "wellbeing-estimate",
					Name:        "estimate",
					HRef:        "http://localhost:22400/code-lists/wellbeing-estimate/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "wellbeing-measureofwellbeing",
					Name:        "allmeasuresofwellbeing",
					HRef:        "http://localhost:22400/code-lists/wellbeing-measureofwellbeing/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					ID:          "yyyy",
					Name:        "time",
					HRef:        "http://localhost:22400/code-lists/yyyy/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "uk-only",
					Name:        "geography",
					...
					Name:        "activity",
					HRef:        "http://localhost:22400/code-lists/business-investment-activity/editions/one-off",
					IsHierarchy: true,
				}, {
					ID:          "business-investment-instrument-asset",
					Name:        "instrumentasset",
					HRef:        "http://localhost:22400/code-lists/business-investment-instrument-asset/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "business-investment-prices",
					Name:        "prices",
					HRef:        "http://localhost:22400/code-lists/business-investment-prices/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "business-investment-activity/editions/one-off",
					Name:        "activity",
					HRef:        "http://localhost:22400/code-lists/business-investment-activity/editions/one-off",
					IsHierarchy: true,
				}, {
			...
			CodeLists: []CodeList{
				{
					...
					Name:        "projectiontype",
					HRef:        "http://localhost:22400/code-lists/npp-all-projectiontype/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-population-age",
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/npp-population-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-all-sex",
					Name:        "sex",
					HRef:        "http://localhost:22400/code-lists/npp-all-sex/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/npp-mortalityandcrossborderrates-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-all-sex",
					Name:        "sex",
			...
			CodeLists: []CodeList{
				{
					...
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/npp-migration-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-all-sex",
					Name:        "sex",
					...
					HRef:        "http://localhost:22400/code-lists/npp-migration-populationmeasure/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/npp-birthsandfertility-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-migration-populationmeasure",
					Name:        "populationmeasure",
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "npp-deaths-age",
					Name:        "age",
					HRef:        "http://localhost:22400/code-lists/npp-deaths-age/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "npp-all-sex",
					Name:        "sex",
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "npp-border",
					Name:        "border",
					HRef:        "http://localhost:22400/code-lists/npp-border/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
			...
			CodeLists: []CodeList{
				{
					...
					ID:          "trade-commodity",
					Name:        "commodity",
					HRef:        "http://localhost:22400/code-lists/trade-commodity/editions/one-off",
					IsHierarchy: true,
				}, {
					ID:          "trade-country",
					Name:        "country",
					HRef:        "http://localhost:22400/code-lists/trade-country/editions/one-off",
					IsHierarchy: false,
				}, {
					ID:          "trade-direction",
					Name:        "direction",
					HRef:        "http://localhost:22400/code-lists/trade-direction/editions/one-off",
					IsHierarchy: false,
				},
			},
		},
